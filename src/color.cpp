...
float   a_lane[4] = {29.0, 26, 43, 21};   // creates/stores average values for each LED in each condition. COLOR SENSOR 1 black, red, blue, yellow
float   a_mag[4];             // creates the vector magnitudes between measured values and each average condition. COLOR SENSOR 1
float   b_lane[4] = {36, 34.2, 40, 31};   // creates/stores average values for each LED in each condition. COLOR SENSOR 2
float   b_mag[4];
